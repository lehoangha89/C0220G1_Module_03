...
@Component({
  selector: 'app-thuchanh-image-gallery',
  templateUrl: './thuchanh-image-gallery.component.html',
  styleUrls: ['./thuchanh-image-gallery.component.css']
})
export class ThuchanhImageGalleryComponent implements OnInit {
  listImage = [
